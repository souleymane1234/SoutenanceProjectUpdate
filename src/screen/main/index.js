...
return () => {
  ...
  return (
       ...
       <View style={{flex: 0.7, width: "100%", margin: 10}}>
        <TouchableOpacity style={{margin: 10, backgroundColor: "#3FB65F", width: 150, height: 30, borderRadius: 10, justifyContent: "center"}} onPress={() => [setText1(1), setModalVisible(true)]}>
            <Text style={{textAlign: "center", color: "#fff"}}>Changez la langue</Text>
        </TouchableOpacity>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <TouchableOpacity 
            onPress={() => [selectFrancais('Francais'), setModalVisible(false)]}
            >
              <Text style={styles.modalText}>Francais</Text>
            </TouchableOpacity>
            <TouchableOpacity 
            onPress={() => [selectFrancais('Djoula'), setModalVisible(false)]}
            >
